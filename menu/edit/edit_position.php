...
if (
  ...
  if (
    ...
    if (!empty($_FILES["photo"]["name"])) {
      uploadImage();
      $task = $db->editMenuPosition($_POST["id"], $_POST["title"], $_POST["description"], $_POST["price"], $_POST["category"], $base_url . "uploads/" . getFileName() . '.jpg');
    }else{
      $task = $db->editMenuPosition($_POST["id"], $_POST["title"], $_POST["description"], $_POST["price"], $_POST["category"], "");
    }
    goToRoute("menu");
  } else {
